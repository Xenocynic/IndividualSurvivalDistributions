 ...
 * - Removes emoji headers / triangles and replaces with lucide-react icons.
 * - Uses consistent gray palette (gray-900 / gray-700 / gray-600).
 * - Buttons match Browse/Dashboard pill buttons (bordered, hover:bg-gray-50).
 */
