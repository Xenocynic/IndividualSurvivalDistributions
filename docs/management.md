...
| User Story ID | Requirement Description | Test Case(s) | Test File | Coverage Status |
|---------------|------------------------|--------------|-----------|----------------|
| US 1.1.1 | Admin can login and logout. | `test_admin_login_logout_reset` | `test_admin_login_logout_reset.py` | Covered |
| US 1.1.1 | Admin can send password reset email to a valid user with a valid email. | `test_admin_login_logout_reset` | `test_admin_login_logout_reset.py` | Covered |
